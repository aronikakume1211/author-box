...
class GATB_Enqueue
{
    public function __construct()
    {
        ...
        add_action('wp_enqueue_scripts', [$this, 'gatb_frontend_script']);
    }
     ...
     */
    public function gatb_frontend_script(){
        // Enqueue the frontend stylesheet
        wp_enqueue_style('gatb-frontend-style', GATB_DIR_URL . 'assets/css/gatb-frontend.css');
    }
}
